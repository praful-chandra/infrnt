    ...
    return (
      <div className="articleSmall row">
        {this.props.content1 ? (
          ...
          <Link to={"/article/"+this.props.content1._id} >  <button className="btn btn-outline-secondary " >Read More</button></Link> 
          </div>
        ...
        {this.props.content2 ? (
          ...
          <Link to={"/article/"+this.props.content2._id} >  <button className="btn btn-outline-secondary " >Read more </button></Link> 
          </div>
        ...
        {this.props.content3 ? (
         ...
         <Link to={"/article/"+this.props.content3._id} >   <button className="btn btn-outline-secondary ">Read more </button></Link> 
          </div>
