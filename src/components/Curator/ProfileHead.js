  ...
  return (
   ...
   <div className="row">
       ...
       <div className="col-md-7 curatorPage-hero-right-desktop">
           ...
           <div className="curatorPage-hero-tags-wrapper">
               <div className="row curatorPage-hero-tags-row">
                   <div className="col-md-3 curatorPage-hero-tags"> #genere </div>
                   <div className="col-md-3 curatorPage-hero-tags"> #genere </div>
                   <div className="col-md-3 curatorPage-hero-tags"> #genere </div>
                   <div className="col-md-3 curatorPage-hero-tags"> #genere </div>
                   <div className="col-md-3 curatorPage-hero-tags"> #genere </div>
      ...
      {/* ------------------------------------------------- Mobile version --------------------------------------------------------------------------------  */}
       ...
       <div className="mobile-curatorPage mobile-curatorPage-box">
           ...
           <div className="mobile-curatorPage-hero-tags-wrapper">
               <div className="row ">
                   <div className="col curatorPage-hero-tags"> #genere </div>
                   <div className="col curatorPage-hero-tags"> #genere </div>
                   <div className="col curatorPage-hero-tags"> #genere </div>
                   <div className="col curatorPage-hero-tags"> #genere </div>
                   <div className="col curatorPage-hero-tags"> #genere </div>
