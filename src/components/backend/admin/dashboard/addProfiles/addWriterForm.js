...
import {addWriter} from "../../../../../actions/adminActions";
 class AddWriterForm extends Component {
  ...
  handleAddFormSubmit = (e)=>{
    e.preventDefault();
 this.props.addWriter(this.state.newProfile);  
...
export default connect(null,{addWriter})(AddWriterForm)